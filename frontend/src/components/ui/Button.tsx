...
export const Button = ({
  ...
  const variants = {
    ...
    outline: 'border-2 border-slate-100 text-slate-700 hover:bg-slate-50 hover:border-slate-200',
  };
  ...
  return (
    <button
      className={cn(
        'inline-flex items-center justify-center rounded-2xl font-bold transition-all duration-300 active:scale-95 hover:translate-y-[-2px] disabled:opacity-50 disabled:pointer-events-none',
        variants[variant],
        sizes[size],
        className
      )}
